...
export default class TablePagination extends Vue {
  ...
  // Computed
  get filterInput () {
    return this.data.filter((item:Data) => item.taxCategory.match(this.filterText)).slice(this.perPage * this.currentPage - this.perPage, this.perPage * this.currentPage)
  }
