...
export default class HelloWorld extends Vue {
  ...
  private sliceData () {
    console.log('par1', this.perPage * this.currentPage - this.perPage)
    console.log('par2', this.perPage * this.currentPage)
    this.sliceDate = this.data.slice(this.perPage * this.currentPage - this.perPage, this.perPage * this.currentPage)
  }
